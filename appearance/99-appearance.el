...
;;; font
(add-to-list 'default-frame-alist '(font . "VL Gothic-17"))
;;; (set-face-attribute 'default t :font "VL Gothic" :height 140)
;;; (set-face-attribute 'default nil :font "VL Gothic" :height 140)
